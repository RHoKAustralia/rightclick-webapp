...
~~~sh
# getting the code
git clone git@github.com:nko5/full-chort.git && cd ./full-chort/
...
# deploying to Modulus (to http://full-chort.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/full-chort" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
